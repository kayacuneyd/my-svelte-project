...
<div class="w3-center">
  <LeftColumn />
  <div class="w3-container w3-card w3-white" id="about">
    <h2 class="w3-text-grey w3-padding-16">
      <i
        class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-grey"
      />Work Experience
    </h2>
    <div class="w3-container">
      ...
      <h6 class="w3-text-grey">
        ...
        <span class="w3-tag w3-grey w3-round">Current</span>
      </h6>
      <p>
  ...
  <div class="w3-container w3-card w3-white" id="publication">
    <h2 class="w3-text-grey w3-padding-16">
      <i
        class="fa fa-certificate fa-fw w3-margin-right w3-xxlarge w3-text-grey"
      />Education
    </h2>
    <div class="w3-container">
  ...
  <div class="w3-container w3-card w3-white" id="phd">
    <h2 class="w3-text-grey w3-padding-16">
      <i
        class="fa fa-certificate fa-fw w3-margin-right w3-xxlarge w3-text-grey"
      />Education
